...
func TestContextParam1(t *testing.T) {
	Convey("context route param", t, func() {
		Convey("param", func() {
			n.Get("/context/p1/:id", func(c *Context) {
				id := c.Param("id")
		...
		Convey("param int", func() {
			n.Get("/context/p2/:id", func(c *Context) {
				id := c.ParamInt("id")
				So(id, ShouldEqual, 123)
			})
		...
		Convey("param int32", func() {
			n.Get("/context/p3/:id", func(c *Context) {
				id := c.ParamInt32("id")
				So(id, ShouldEqual, 123)
			})
		...
		Convey("param int64", func() {
			n.Get("/context/p4/:id", func(c *Context) {
				id := c.ParamInt64("id")
				So(id, ShouldEqual, 123)
			})
		...
		Convey("param float", func() {
			n.Get("/context/p5/:id", func(c *Context) {
				id := c.ParamFloat("id")
		...
		Convey("param bool", func() {
			n.Get("/context/p6/:id", func(c *Context) {
				id := c.ParamBool("id")
...
func TestContextQuery1(t *testing.T) {
	Convey("context query param", t, func() {
		Convey("query string param", func() {
			n.Get("/context/1/:id", func(c *Context) {
				id := c.Query("p")
				So(id, ShouldEqual, "123")
			})
		...
		Convey("form string param", func() {
			n.Post("/context/2/:id", func(c *Context) {
				id := c.Query("p")
				So(id, ShouldEqual, "123")
			})
			data := url.Values{}
		...
		Convey("type param", func() {
			n.Post("/context/3/:id", func(c *Context) {
				var p interface{}
				p = c.QueryInt("int")
		...
		Convey("querys/gets, not contains form data", func() {
			n.Post("/context/4/:id", func(c *Context) {
				querys := c.Querys()
			...
			data.Add("n", "2")
			data.Add("d", "2")
			req, _ := http.NewRequest("POST", "/context/4/1?a=1&n=1&d=1&d=2", strings.NewReader(data.Encode()))
			req.Header.Set("Content-Type", ApplicationForm)
			w := httptest.NewRecorder()
			n.ServeHTTP(w, req)
			So(w.Code, ShouldEqual, http.StatusOK)
		...
		Convey("posts, not contains get params", func() {
			n.Post("/contextp/:id", func(c *Context) {
				querys := c.Posts()
				So(querys, ShouldNotBeNil)
				p := querys["a"].(string)
				So(p, ShouldEqual, "2")
			...
			data.Add("d", "2")
			data.Add("d", "3")
			req, _ := http.NewRequest("POST", "/contextp/1?a=1&n=1&d=1", strings.NewReader(data.Encode()))
			req.Header.Set("Content-Type", ApplicationForm)
			w := httptest.NewRecorder()
			n.ServeHTTP(w, req)
			So(w.Code, ShouldEqual, http.StatusOK)
		...
		Convey("body json param", func() {
			...
			n.Post("/context/json", func(c *Context) {
		...
		Convey("body json param nil", func() {
			dataSource := map[string]interface{}{"test": "json"}
			n.Post("/context/json2", func(c *Context) {
		...
		Convey("body json param diffrent struct", func() {
			dataSource := map[string]interface{}{"test": "json"}
			n.Post("/context/json3", func(c *Context) {
		...
		Convey("body json param is empty", func() {
			n.Post("/context/json/empty", func(c *Context) {
				var dataFromBody map[string]interface{}
		...
		Convey("body xml param", func() {
			...
			n.Post("/context/xml", func(c *Context) {
		...
		Convey("body xml param is empty", func() {
			n.Post("/context/xml/empty", func(c *Context) {
				var dataFromBody map[string]interface{}
...
func TestContextFile1(t *testing.T) {
	Convey("context file", t, func() {
		n.Post("/file", func(c *Context) {
			c.Posts()
			c.GetFile("file1")
			c.SaveToFile("file1", "/tmp/nice.jpg")
			c.SaveToFile("file1", "/tmpx/nice.jpg")
			c.SaveToFile("file2", "/tmpx/nice.jpg")
		})
		data := make(map[string]string)
		data["a"] = "1"
		req, _ := newfileUploadRequest("/file", data, "file1", "./_fixture/img/nice.jpg")
		w := httptest.NewRecorder()
		n.ServeHTTP(w, req)
		So(w.Code, ShouldEqual, http.StatusOK)
	})
...
func TestContextCookie1(t *testing.T) {
	Convey("context cookie", t, func() {
		Convey("cookie get", func() {
			n.Get("/cookie/get", func(c *Context) {
				var p interface{}
				p = c.GetCookie("s")
				So(p, ShouldEqual, "123")
		...
		Convey("cookie set", func() {
			n.Get("/cookie/set", func(c *Context) {
				c.SetCookie("name", "nice")
				c.SetCookie("name", "nice", 10)
				c.SetCookie("name", "nice", int32(10))
				c.SetCookie("name", "nice", int64(10))
				c.SetCookie("name", "nice", 10, "/")
				c.SetCookie("name", "nice", 10, "/", "localhost")
				c.SetCookie("name", "nice", 10, "/", "localhost", "1")
				c.SetCookie("name", "nice", 10, "/", "localhost", true, true)
			})
			w := request("GET", "/cookie/set")
			So(w.Code, ShouldEqual, http.StatusOK)
			So(w.Header().Get("set-cookie"), ShouldContainSubstring, "name=nice;")
		})
	})
}
...
func TestContextWrite1(t *testing.T) {
	Convey("context writer", t, func() {
		Convey("write string", func() {
			n.Get("/writer/string", func(c *Context) {
				c.String(200, "abc\n")
			})
		...
		Convey("write byte", func() {
			n.Get("/writer/byte", func(c *Context) {
				c.Text(200, []byte("abc\n"))
			})
		...
		Convey("write JSON", func() {
			n.Get("/writer/json", func(c *Context) {
		...
		Convey("write JSON error", func() {
			n.Get("/writer/json/error", func(c *Context) {
				data := f
				c.JSON(200, data)
			})
		...
		Convey("write JSONString", func() {
			n.Get("/writer/jsonstring", func(c *Context) {
				data := map[string]interface{}{"a": "1"}
		...
		Convey("write JSONString error", func() {
			n.Get("/writer/jsonstring/error", func(c *Context) {
				data := f
				str, _ := c.JSONString(data)
				c.String(200, str)
			})
		...
		Convey("write JSONP", func() {
			n.Get("/writer/jsonp", func(c *Context) {
				data := map[string]interface{}{"a": "1"}
		...
		Convey("write JSONP error", func() {
			n.Get("/writer/jsonp/error", func(c *Context) {
				data := f
				callback := c.Query("callback")
				c.JSONP(200, callback, data)
			})
		...
		Convey("write XML", func() {
			n.Get("/writer/xml", func(c *Context) {
				type XMLNode struct {
				...
				data := &XMLNode{Name: "nice", ID: 1, Addr: "beijing"}
				c.XML(200, data)
			})
		...
		Convey("write XML error", func() {
			n.Get("/writer/xml/error", func(c *Context) {
...
func TestConextRedirect1(t *testing.T) {
	Convey("redirect", t, func() {
		Convey("redirect normal", func() {
			n.Get("/redirect/1", func(c *Context) {
				c.Redirect(301, "/")
			})
		...
		Convey("redirect error", func() {
			n.Get("/redirect/2", func(c *Context) {
				c.Redirect(500, "/")
			})
...
func TestContextIP1(t *testing.T) {
	Convey("get remote addr", t, func() {
		n.Get("/ip", func(c *Context) {
			ip := c.RemoteAddr()
			ip = c.RemoteAddr()
			ip = c.RemoteAddr()
			So(ip, ShouldEqual, "10.1.2.1")
		})
		n.Get("/ip2", func(c *Context) {
			ip := c.RemoteAddr()
			So(ip, ShouldBeEmpty)
		})
		req, _ := http.NewRequest("GET", "/ip", nil)
		req.Header.Set("X-Forwarded-For", "10.1.2.1, 10.1.2.2")
		w := httptest.NewRecorder()
		n.ServeHTTP(w, req)
		So(w.Code, ShouldEqual, http.StatusOK)
...
func TestContext2(t *testing.T) {
	Convey("request methods", t, func() {
		...
		Convey("occur error", func() {
			n.Get("/error2", func(c *Context) {
				c.Error(nil)
			})
			n.Get("/notfound3", func(c *Context) {
				c.NotFound()
			})
...
func TestContextNice1(t *testing.T) {
	Convey("get nice", t, func() {
		Convey("get nice", func() {
			So(c.Nice(), ShouldNotBeNil)
		})
		Convey("get di", func() {
			logger := c.DI("logger")
			_, ok := logger.(Logger)
